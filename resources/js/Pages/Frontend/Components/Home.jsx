                        ...
                        <div className="col-md-6 wrap-about ftco-animate">
                            <div className="heading-section heading-section-white pl-md-5">
                                ...
                                <p>
                                    ...
                                    the Little Blind Text, that where it came
                                    from it would have been rewritten a thousand
                                    times and everything that was left from its
                                    origin would be the word "and" and the
                                    Little Blind Text should turn around and
                                    return to its own, safe country. A small
                    ...
                    <div className="row">
                        <div className="col-md-12 text-center">
                            <p>
                                ...
                                Copyright © All rights reserved | This template
                                is made with{" "}
                                <i
